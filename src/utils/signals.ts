...
export const signChange: ActionFactory = ({ reloadPage = true, bgChanged = false, contentChanged = false, pageChanged = false }) => ({
  payload: { reloadPage, bgChanged, contentChanged, pageChanged },
  type: SIGN_CHANGE,
});
